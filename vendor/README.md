...
`dsh-ops-release-contract-0.1.0.tgz` 是产品仓库 `packages/shared/release-contract` 的原始 pnpm pack 产物。来源提交、输入哈希与制品 SHA-256 记录在 [release-contract.json](release-contract.json)。源包由产品仓库维护；官网不直接修改制品内的校验器。
